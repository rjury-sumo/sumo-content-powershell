# auto generated by srcgen healthEvents 11/16/2020 5:28:46 PM 
...
function New-HealthEventResources {
   ...
   Param(
    ...
    return (invoke-sumo -path "healthEvents/resources" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
