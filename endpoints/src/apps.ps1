# auto generated by srcgen apps 11/16/2020 5:28:45 PM 
...
function New-AppInstallById {
   ...
   Param(
    ...
    return (invoke-sumo -path "apps/$uuid/install" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
