# auto generated by srcgen apps 11/13/2020 3:29:44 PM 
...
function Get-AppInstallStatuById {
...
function New-AppInstallById {
   ...
   Param(
    ...
    return (invoke-sumo -path "apps/$uuid/install" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
