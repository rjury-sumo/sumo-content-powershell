# auto generated by srcgen transformationRules 11/16/2020 5:28:46 PM 
...
function New-TransformationRule {
   ...
   Param(
    ...
    return (invoke-sumo -path "transformationRules" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-TransformationRuleById {
   ...
   Param(
    ...
    return (invoke-sumo -path "transformationRules/$id" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
