# auto generated by srcgen lookupTables 11/16/2020 5:28:46 PM 
...
function New-LookupTable {
   ...
   Param(
    ...
    return (invoke-sumo -path "lookupTables" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-LookupTableById {
   ...
   Param(
    ...
    return (invoke-sumo -path "lookupTables/$id" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-LookupTableDeleteTableRowById {
   ...
   Param(
    ...
    return (invoke-sumo -path "lookupTables/$id/deleteTableRow" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-LookupTableRowById {
   ...
   Param(
    ...
    return (invoke-sumo -path "lookupTables/$id/row" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function New-LookupTableTruncateById {
   ...
   Param(
    ...
    return (invoke-sumo -path "lookupTables/$id/truncate" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function New-LookupTableUploadById {
   ...
   Param(
    ...
    return (invoke-sumo -path "lookupTables/$id/upload" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
