# auto generated by srcgen connections 11/13/2020 3:29:44 PM 
...
function New-Connection {
   ...
   Param(
    ...
    return (invoke-sumo -path "connections" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-ConnectionsTest {

   Param(
        [parameter()][SumoAPISession]$sumo_session = $sumo_session,
        [parameter(mandatory=$True)]$body
    )
    return (invoke-sumo -path "connections/test" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function Set-ConnectionById {
   ...
   Param(
    ...
    return (invoke-sumo -path "connections/$id" -method PUT -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
