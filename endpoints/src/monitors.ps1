# auto generated by srcgen monitors 11/13/2020 3:29:44 PM 
...
function Get-MetricsAlertMonitor {
...
function New-MetricsAlertMonitor {
   ...
   Param(
    ...
    return (invoke-sumo -path "metricsAlertMonitors" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function Set-MetricsAlertMonitorById {
   ...
   Param(
    ...
    return (invoke-sumo -path "metricsAlertMonitors/$id" -method PUT -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-MetricsAlertMonitorMuteById {
   ...
   Param(
    ...
    return (invoke-sumo -path "metricsAlertMonitors/$id/mute" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-MetricsAlertMonitorUnmuteById {
   ...
   Param(
    ...
    return (invoke-sumo -path "metricsAlertMonitors/$id/unmute" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-Monitor {
   ...
   Param(
    ...
    return (invoke-sumo -path "monitors" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function Set-MonitorById {
   ...
   Param(
    ...
    return (invoke-sumo -path "monitors/$id" -method PUT -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-MonitorCopyById {
   ...
   Param(
    ...
    return (invoke-sumo -path "monitors/$id/copy" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-MonitorMoveById {
   ...
   Param(
    ...
    return (invoke-sumo -path "monitors/$id/move" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-MonitorImportById {
   ...
   Param(
    ...
    return (invoke-sumo -path "monitors/$parentId/import" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
