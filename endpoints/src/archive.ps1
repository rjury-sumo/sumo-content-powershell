# auto generated by srcgen archive 11/16/2020 5:28:46 PM 
...
function New-ArchiveJobsById {
   ...
   Param(
    ...
    return (invoke-sumo -path "archive/$sourceId/jobs" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
