# auto generated by srcgen ingestBudgets 11/16/2020 5:28:46 PM 
...
function New-IngestBudgetsv1 {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-IngestBudgetv1ById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-IngestBudgetv1CollectorsById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id/collectors/$collectorId" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Reset-IngestBudgetv1UsageResetById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id/usage/reset" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function New-IngestBudgetsv2 {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets" -method POST -session $sumo_session -v 'v2' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-IngestBudgetv2ById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id" -method PUT -session $sumo_session -v 'v2' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Reset-IngestBudgetv2UsageResetById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id/usage/reset" -method POST -session $sumo_session -v 'v2' -body ($body | ConvertTo-Json -depth 10) )
}
