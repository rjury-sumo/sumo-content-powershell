# auto generated by srcgen ingestBudgets 11/13/2020 3:29:45 PM 
...
function New-IngestBudgetsv1 {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function Set-IngestBudgetv1ById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id" -method PUT -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function Get-IngestBudgetv1CollectorById {
...
function Set-IngestBudgetv1CollectorsById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id/collectors/$collectorId" -method PUT -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function Reset-IngestBudgetv1UsageResetById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id/usage/reset" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function New-IngestBudgetsv2 {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Set-IngestBudgetv2ById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id" -method PUT -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Reset-IngestBudgetv2UsageResetById {
   ...
   Param(
    ...
    return (invoke-sumo -path "ingestBudgets/$id/usage/reset" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
