# auto generated by srcgen fields 11/13/2020 3:29:44 PM 
...
function New-Field {
   ...
   Param(
    ...
    return (invoke-sumo -path "fields" -method POST -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
...
function Reset-FieldDisableById {
...
function Reset-FieldEnableById {
   ...
   Param(
    ...
    return (invoke-sumo -path "fields/$id/enable" -method PUT -session $sumo_session -v 'v1' -Body ($body | ConvertTo-Json) )
}
