# auto generated by srcgen dashboards 11/13/2020 3:29:45 PM 
...
function New-Dashboard {
   ...
   Param(
    ...
    return (invoke-sumo -path "dashboards" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Set-DashboardById {
   ...
   Param(
    ...
    return (invoke-sumo -path "dashboards/$id" -method PUT -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
