# auto generated by srcgen content 11/13/2020 3:29:45 PM 
...
function New-ContentFolder {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/folders" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Get-ContentFoldersAdminRecommendedStatuById {
...
function Get-ContentFoldersGlobalStatuById {
...
function New-ContentFoldersImportById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/folders/$folderId/import" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Get-ContentFoldersImportStatuById {
...
function Set-ContentFoldersById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/folders/$id" -method PUT -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Get-ContentExportStatuById {
...
function New-ContentCopyById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/copy" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Get-ContentCopyStatuById {
...
function Get-ContentDeleteStatuById {
...
function New-ContentExportById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/export" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function New-ContentMoveById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/move" -method POST -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Get-ContentPermissionById {
...
function Set-ContentPermissionsAddById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/permissions/add" -method PUT -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
...
function Set-ContentPermissionsRemoveById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/permissions/remove" -method PUT -session $sumo_session -v 'v2' -Body ($body | ConvertTo-Json) )
}
