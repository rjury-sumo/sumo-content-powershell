# auto generated by srcgen content 11/20/2020 9:17:49 AM 
...
function New-ContentFolders {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/folders" -method POST -session $sumo_session -v 'v2' -body $body )
}
...
function New-ContentFoldersImportById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/folders/$folderId/import" -method POST -session $sumo_session -v 'v2' -body $body )
}
...
function New-ContentCopyById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/copy" -method POST -session $sumo_session -v 'v2' -body $body )
}
...
function Remove-ContentDeleteById {
...
function New-ContentExportById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/export" -method POST -session $sumo_session -v 'v2' -body $body )
}
...
function New-ContentMoveById {
   ...
   Param(
    ...
    return (invoke-sumo -path "content/$id/move" -method POST -session $sumo_session -v 'v2' -body $body )
}
