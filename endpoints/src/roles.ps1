# auto generated by srcgen roles 11/16/2020 5:28:46 PM 
...
function New-Role {
   ...
   Param(
    ...
    return (invoke-sumo -path "roles" -method POST -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-RoleById {
   ...
   Param(
    ...
    return (invoke-sumo -path "roles/$id" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
...
function Set-RoleUserById {
   ...
   Param(
    ...
    return (invoke-sumo -path "roles/$roleId/users/$userId" -method PUT -session $sumo_session -v 'v1' -body ($body | ConvertTo-Json -depth 10) )
}
