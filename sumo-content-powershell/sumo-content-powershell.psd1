...
FunctionsToExport = @('new-ContentSession','getQueryString','invoke-sumo','copy-proppy','convertSumoDecimalContentIdToHexId','New-MultipartBoundary','batchReplace','Get-AccessKeys','Get-Apps','New-AppInstallById','Install-SumoApp','get-collectors','get-offlineCollectors','get-collectorById','get-collectorByName','Get-Connections','get-ContentByPath','get-ContentPath','start-ContentExportJob','get-ContentExportJobStatus','get-ContentExportJobResult','get-ExportContent','start-ContentCopyJob','get-ContentCopyJobStatus','start-ContentImportJob','Get-ContentFoldersImportStatusById','Move-ContentById','Get-ContentFolderById','Set-ContentFoldersById','New-Dashboard','Get-DashboardContentIdById','Get-ExtractionRules','Get-Fields','get-Folder','get-PersonalFolder','get-GlobalFolder','get-adminRecommended','get-folderJobStatus','get-folderJobResult','get-folderContent','new-folder','Get-HealthEvents','Get-HealthEventResources','Get-IngestBudgetsv1','New-IngestBudgetsv1','Remove-IngestBudgetv1ById','Get-IngestBudgetv1ById','Set-IngestBudgetv1ById','Get-IngestBudgetv1CollectorsById','Remove-IngestBudgetv1CollectorsById','Set-IngestBudgetv1CollectorsById','Reset-IngestBudgetv1UsageResetById','Get-IngestBudgetsv2','New-IngestBudgetsv2','Remove-IngestBudgetv2ById','Get-IngestBudgetv2ById','Set-IngestBudgetv2ById','Reset-IngestBudgetv2UsageResetById','Get-LogSearchesEstimatedUsage','New-LookupTable','Get-LookupTableJobsStatusById','Remove-LookupTableById','Get-LookupTableById','Set-LookupTableById','Remove-LookupTableRowById','New-LookupTableRowById','New-LookupTableTruncateById','Set-LookupTableFromCsv','Get-MetricsAlertMonitors','New-MetricsSearch','Get-Partitions','Get-ContentPermissionsById','Set-ContentPermissionsAddById','Set-ContentPermissionsRemoveById','Get-Roles','New-Role','Remove-RoleById','Get-RoleById','Set-RoleById','Remove-RoleUserById','Set-RoleUserById','get-scheduledViews','get-epochDate ','sumotime','sumolast','epocvalidation ','New-SearchQuery','New-SearchJob','get-SearchJobStatus','Export-SearchJobEvents','get-SearchJobResult','get-sources','get-sourceById','Get-Users' )
